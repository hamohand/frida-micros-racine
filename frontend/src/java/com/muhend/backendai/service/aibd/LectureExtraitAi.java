    ...
    * Constructeur pour l'injection des dépendances.
    ...
    public static ExtraitNaissanceEntity ficheExtraitNaissanceEntity(Document docPdfResponseAi) {
        ...
        for (int i_entitie = 0; i_entitie < nbChamps; i_entitie++) {
            ...
            mentionText = MethodesChaine.replaceTrimSpaces(mentionText, '.'); //supprime les éventuels points qui se rajoutent aux données

            switch (type) {
                case "nom":
                    //nomPrenom
                    fiche.setNomPrenom(mentionText);
                    break;
                case "ancien":
                    //latines;
                ...
                case "pere":
                    ...
                    break;
                case "numExtrait":
                    fiche.setNumExtrait(mentionText);
                    break;
                case "marge":
