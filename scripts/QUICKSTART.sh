...
echo "  🏗️  docs/ARCHITECTURE.md               → Architecture du projet"
echo "  🚀 docs/architecture/deploiement_vps.md → Déploiement VPS"
echo "  🏢 install-notaire/documentation/     → Installation chez un notaire"
echo ""
echo "═══════════════════════════════════════════════════════════"
echo ""
